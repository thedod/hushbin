...
This is a self-contained single page javascript app for symmetric cryptograhy (RC4, essentially). It had "pastebin":http://pastebin.com integration for better interoperability with social networking (just tweet the pastebin's url).

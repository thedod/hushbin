...
_tidy.html_ (about 12K) is the same thing after going throuh <code>tidy -i</code> and is more readable, but the master is _index.html_ (e.g. _tidy.html_ has the wrong charset definition. See if I care :) ).
